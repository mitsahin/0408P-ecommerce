    ...
    <section className="flex w-full flex-col gap-8">
      ...
      <div className="flex w-full flex-col gap-6 rounded border border-slate-200 bg-white p-4 sm:flex-row sm:items-start sm:gap-8">
        <div className="flex w-full flex-col gap-4 sm:w-[50%]">
          <div className="flex w-full items-center justify-center rounded bg-white">
            <img
              src={activeImage}
              alt={product.title}
      ...
      <div className="flex w-full flex-col gap-6 rounded border border-slate-200 bg-white p-4">
        <div className="flex flex-wrap items-center gap-6 text-sm font-semibold text-slate-500">
          <button
            ...
            className={activeTab === 'description' ? 'text-slate-900' : ''}
          >
            Description
          </button>
          <button
            ...
            className={activeTab === 'additional' ? 'text-slate-900' : ''}
          >
          ...
          <button
            ...
            className={activeTab === 'reviews' ? 'text-slate-900' : ''}
          >
            Reviews (0)
          </button>
        </div>
